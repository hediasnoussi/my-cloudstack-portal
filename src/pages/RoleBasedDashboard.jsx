...
const RoleBasedDashboard = () => {
  ...
  const loadDashboardData = async () => {
    try {
      ...
      // TODO: Remplacer par de vrais appels API pour les VPS
      // Pour l'instant, on garde les données simulées avec plus d'exemples
      setVpsList([
        { id: 1, name: 'VPS-Web-01', status: 'running', cpu: 2, ram: 4, storage: 50, ip: '192.168.1.100', os: 'Ubuntu Linux (64-bit)', created: '2024-01-15' },
        { id: 2, name: 'VPS-DB-01', status: 'stopped', cpu: 4, ram: 8, storage: 100, ip: '192.168.1.101', os: 'CentOS 8 (64-bit)', created: '2024-01-10' },
        { id: 3, name: 'VPS-Mail-01', status: 'running', cpu: 1, ram: 2, storage: 30, ip: '192.168.1.102', os: 'Debian 11 (64-bit)', created: '2024-01-20' },
        { id: 4, name: 'VPS-Game-01', status: 'running', cpu: 8, ram: 16, storage: 200, ip: '192.168.1.103', os: 'Windows Server 2022', created: '2024-01-05' },
        { id: 5, name: 'VPS-Dev-01', status: 'stopped', cpu: 2, ram: 4, storage: 80, ip: '192.168.1.104', os: 'Ubuntu Linux (64-bit)', created: '2024-01-18' },
        { id: 6, name: 'VPS-Backup-01', status: 'running', cpu: 4, ram: 8, storage: 500, ip: '192.168.1.105', os: 'CentOS 7 (64-bit)', created: '2024-01-12' },
      ]);
